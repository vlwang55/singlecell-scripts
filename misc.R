...
pancdevlist <- c('PDX1', 'NKX6-1', 'GATA4', 'GATA6', 'PTF1A', 'ONECUT1')
obj <- AddModuleScore(obj, features = list(pancdevlist), name = "PancDev_Score")
VlnPlot(obj, features = c("PancDev_Score1"), group.by = "orig.ident")
